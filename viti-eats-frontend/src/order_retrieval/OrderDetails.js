        ...
        <>
          <table class="table table-bordered">
            <tbody>
              ...
              <tr>
                <td class="text-left">Delivery Boy</td>
                <td class="text-left">{deliveryboy_name}</td>
              </tr>
            </tbody>
          </table>
        </>
